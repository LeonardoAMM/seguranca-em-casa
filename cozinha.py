...
cont = pygame.image.load('imagens/tileset/cozinha/cont.png')
fogao = pygame.image.load('imagens/tileset/cozinha/fogao.png')
geladeira = pygame.image.load('imagens/tileset/cozinha/geladeira.png')
lixo = pygame.image.load('imagens/tileset/cozinha/lixo.png')
balde = pygame.image.load('imagens/tileset/cozinha/balde.png')
...
class Cozinha:
    ...
    def drawa(self):
        ...
        if self.eventos[0]==1:
            self.andar=False
            self.game.hud.draw('Leo','Ué!!! Quem deixou esse balde de água','aqui na cozinha?')
        if self.eventos[0]==2:
            self.andar=False
            self.game.hud.draw('Leo','Talvez ele possa me ajudar a apagar o fogo.','')
        if self.eventos[0]==3:
            self.andar=False
        ...
        if self.eventos[0]==5:
            self.andar=False
            self.game.hud.draw('Leo','Beleza, vai ser isso mesmo.','')
        if self.eventos[0]==7:
            self.andar=False
            self.game.hud.draw('Leo','Já estou com as mãos ocupadas, não posso',' pegar o balde.')
